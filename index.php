...
<body>
	...
	<nav class="navbar navbar-expand-md navbar-light bg-light sticky-top" >
		<div class="container">
			...
			<div class="logotext">
				<a href="javascript://0" onclick = "slowScroll ('#top')" class="navbar-brand"><h1><span>Easy</span>Speak<br><p>language courses</p></h1></a>
			</div>
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item dropdown"><a href="#" class="nav-link dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Услуги</a>
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
				            <a class="dropdown-item" href="javascript://0" onclick = "slowScroll ('#course')">Курсы базового английского</a>
				            <a class="dropdown-item" href="javascript://0" onclick = "slowScroll ('#children')">Курсы английского для детей</a>
          				</div>
      				</li>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-xs-12 col-12">
					<h1>Учиться никогда не поздно</h1><br>
					<p>Выучи английский язык вместе с EasySpeak</p>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4">
					<div class="button">Записаться сейчас</div>
				</div>
			</div>
		</div>
	</section>
			...
			<div class="container">
				<div class="row">
						<div class="col-12 col-md-7 offset-md-1">
							<div class="text">
								<div class="info">
								<h1>Несколько слов о <br>нашей компании</h1><br>
								<p class="first">Мы предоставляем качественные курсы<br>английского языка и соответствуем<br>международным стандартам CEFR.</p>
								<p class="second">В конце обучающего курса, после успешной<br>сдачи контрольного теста наши студенты<br>получают международный сертификат.</p>
								<div class="button inffo">Подробнее</div>
							</div>
							</div>
						</div>
						<div class="col-md-4">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-7 offset-md-1">
						<div class="uptext">
							<h1>Мы предлагаем <span>широкий спектр</span><br>курсов английского языка</h1>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-5 offset-md-1"><p><span>EasySpeak</span> - это компания, которая предоставляет<br>высочайшее качество английских курсов уже более<br>15 лет. Просмотрите наши предложения и выберите<br>подходящий вашему уровню английского курс.</p></div>
					<div class="col-md-6"><p><span>EasySpeak</span> поможет вам преодолеть языковой барьер<br>в развлекательной и приятной атмосфере. Здесь преподают<br>профессионалы своего дела, которые получали языковое<br>образование в лучших университетах Европы.</p></div>
				</div>
			</div>
			<div class="baseng">
			<div class="container">
                ...
                ?>
							<div class="col-12 col-md-3 col-sm-12 firrst">
								<div class="baseng_top"><?php
									...
									?></div>
								<div class="baseng_img"><img src="img/abc.png" alt="alphabet"></div>
								<div class="baseng_title"><p>Курс для тех, кто<br>начинает учить<br>английский с нуля или<br>имеет начальные<br>знания английского.</p></div>
								<div class="baseng_opportunities"> <p>Пройдя курс вы сможете:</p></div>
								<div class="baseng_list">
									<ul>
										<li class="list_item"><i class="fas fa-check-circle"></i> Использовать базовую<br><span>лексику и грамматику</span></li>
										<li class="list_item"><i class="fas fa-check-circle"></i> Общаться на простые<br><span>и популярные темы</span></li>
										<li class="list_item"><i class="fas fa-check-circle"></i> Читать и писать<br><span>несложные тексты</span></li>
										<li class="list_item"><i class="fas fa-check-circle"></i> Воспринимать на слух<br><span>английский язык</span></li>
									</ul>
								</div>
